...
export class GameController {
    ...
    async create(
        ...
        const winningPlayerEntity = {...await this.players.findPlayer(
            winningPlayer,
        )};
        const loosingPlayerEntity = {...await this.players.findPlayer(
            loosingPlayer,
        )};

        console.log(winningPlayerEntity.firstName)
        ...
        console.log(loosingPlayerEntity.firstName)
